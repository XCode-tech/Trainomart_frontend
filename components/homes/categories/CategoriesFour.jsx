          ...
          <div className="col-auto">
            <div className="sectionTitle ">
              ...
              <p className="sectionTitle__text ">
                Whether you're a beginner taking your first steps in the IT world or an experienced professional looking to upgrade your skills, we have the tools, resources, and expertise to guide you towards success. Our passion is to guide you through the intricate world of technology with hands-on, instructor-led training that empowers and enriches your IT expertise.
              </p>
            </div>
          </div>
        </div>
